        ...
        <>
            <div className=" mt-4 relative ">
                <div className="container-custom flex flex-col justify-start items-start">
                    ...
                    <div className="w-full mt-5">
                        {product?.foods.map((val:Food, i) => (
                            <div
                                ...
                                className=" w-1/2 border border-slate-300 p-4 bg-slate-100 text-slate-700 rounded-lg m-2 grid grid-cols-12 hover:bg-red-50 cursor-pointer"
                            >
                    ...
                    >{selectedFoodItem?<div className="">
                      <Image
