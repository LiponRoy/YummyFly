...
const FoodDetail = ({ params }: { params: Promise<FoodProps["params"]> }) => {
    ...
    // Available Deals
    const [openAvailableDealsModal, setOpenAvailableDealsModal] =
        useState<Boolean>(false);
    const [selectedAvailableDeals, setSelectedAvailableDeals] =
        useState<IAvailableDeals>();
        ...
        <div className="container-custom ">
            <div className="container-custom mt-4 relative grid grid-cols-12 ">
                <div className="col-span-9 w-full flex flex-col justify-start items-start">
                                ...
                                <div className="">
                                    ...
                                    <div className=" ml-4">
                                        ...
                                        <div className="flex flex-col justify-start items-start mt-4">
                                            ...
                                            {product?.moreInfo?.OpeningHours.map(
                                                (val, i) => (
                                                    <div key={i} className="">
                                                        {val}
                                                    </div>
                    ...
                    <span className=" text-start text-[24px] font-medium mb-2">
                        All Food Menu :
                    </span>
                    <div className="grid grid-cols-2 gap-2">
                        {product?.foods.map((val: IFood, i) => (
                            <div
                                ...
                                className=" w-[450px] h-[154px] border border-slate-300 p-4 bg-slate-100 text-slate-700 rounded-lg  grid grid-cols-12 hover:bg-red-50 cursor-pointer"
                            >
                    ...
                    <Modal
                        isOpen={openFoodItemModal}
                        onClose={() => setOpenFoodItemModal(false)}
                        header="food item"
                    >
                        {selectedFoodItem ? (
                            <div className="">
