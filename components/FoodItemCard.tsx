...
const FoodItemCard = ({ val, clickPerFoodItem }: any) => {
  return (
    <div
      ...
      className=" w-full md:w-[420px] h-[154px] border border-slate-300 p-4 bg-slate-100 text-slate-700 rounded-lg  grid grid-cols-12 hover:bg-red-50 cursor-pointer "
    >
